...
@else
  <div class="row">
  <h3 class="col-lg-4 col-xs-12 topmenu-title">Gambar Slideshow</h3>
  ...
  <ul id="sortable" class="parent-menu default">
    @foreach($sliders as $slider)
        <li id="slider_{{ $slider->id }}">
          <div class="row">
          <div class="col-lg-4 col-xs-12 topmenu-list">
          ...
          <div style="padding-top:1em;padding-bottom:2em" class="col-lg-2">
